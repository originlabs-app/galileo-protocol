...
Agree how much recent work the brand could tolerate losing, and how quickly it needs access restored. Those are service requirements to negotiate for the actual operation. They should not be invented from a generic industry benchmark.
...
- **Recovery access:** where the copy is kept, who can retrieve it and how access works if the ordinary account is unavailable.
