...
A transfer agent helps maintain securities ownership records. The [SEC's proposed Transfer Agent Rules](https://www.sec.gov/files/rules/proposed/2026/34-106246.pdf), dated 1 September, address how those records are maintained and controlled. The proposal discusses electronic records and linked systems while retaining responsibility for the authoritative record.
