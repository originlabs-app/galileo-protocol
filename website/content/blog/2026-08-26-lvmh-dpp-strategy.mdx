...
No date is set for luxury categories. Obligations arrive through ESPR delegated acts per product group; textiles are among the first priorities of the [ESPR 2025–2030 working plan](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A52025DC0187), and the battery passport — the reference implementation — is mandatory from 18 February 2027. Watches, jewelry and leather goods may be covered by later delegated acts; no calendar is published.
