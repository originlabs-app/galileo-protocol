...
faq:
  ...
  - question: "Is the F.P. Journe certificate transferable when the watch is resold?"
    answer: "Not in the way a transferable token would be. The certificate is nominative: it attests, for a named requester, that a specific watch was examined and certified by the manufacture. A new buyer who wants the manufacture's word must start a new request through a Boutique. Nothing in the public documentation describes a proof that passes from seller to buyer and that the buyer can verify independently at the moment of the transaction."
...
F.P. Journe displays a warning on its own official website: the watches, clocks and related products shown are counterfeits, and collectors should "exercise the utmost vigilance and contact us before purchasing". The Geneva manufacture has built a serious institutional answer to fakes — but none of its instruments produces a proof that travels with the watch.

That missing instrument, a portable proof a buyer can verify at the moment of the transaction, is the real subject of this week's story.
...
<div style={{ margin: '2rem 0', padding: '1.25rem 1rem', background: 'var(--graphite)', border: '1px solid rgba(0, 255, 255, 0.1)', borderRadius: '0.75rem' }}>
  <svg viewBox="0 0 440 316" role="img" aria-label="Diagram of the verification paths available to a secondary-market buyer of an F.P. Journe watch today. Path one: contact a Boutique for a Certificate of Authenticity — the watch must be certified by the Boutique, it is available only for timepieces sold more than five years ago, and the document is nominative, made out to the requester. Path two: buy through the Patrimoine service — the manufacture buys back, restores and resells with a three-year warranty, but only for rare out-of-production pieces inside its own channel. Path three: trust the seller and available papers — this is where the warning popup asks collectors to contact the manufacture before purchasing, drawn as the unprotected path." style={{ width: '100%', height: 'auto', display: 'block' }} fontFamily="ui-sans-serif, system-ui, sans-serif">
    ...
    <text x="84" y="191" textAnchor="middle" fontSize="9" fill="rgba(255, 255, 255, 0.55)">Issued to the requester,</text>
    <text x="84" y="203" textAnchor="middle" fontSize="9" fill="rgba(255, 255, 255, 0.55)">not to the watch</text>
    ...
    <text x="220" y="261" textAnchor="middle" fontSize="10" fontWeight="600" fill="#22D3EE">No proof travels with the watch between private hands</text>
    <text x="220" y="276" textAnchor="middle" fontSize="9" fill="rgba(255, 255, 255, 0.7)">Every resale re-opens the question the last certificate answered once</text>
...
The certificate is **boutique-mediated**: obtaining the manufacture's word means routing the physical watch, or its owner, through an F.P. Journe Boutique. It is **time-gated**: only timepieces sold more than five years ago are eligible. Above all, it is **nominative**: it attests to a named requester that a specific watch was examined. It is not a transferable token attached to the object.

So the instrument answers a question of ownership and comfort — "is my watch genuine" — for one holder, at one moment. It does not answer the market's question at the moment that matters most: the instant a stranger is about to pay. At that instant, the only options are the ones the warning itself names: contact the manufacture, or rely on a professional's expertise. The manufacture's authority must be re-invoked for every transaction, watch by watch, holder by holder.

The Patrimoine service shows the manufacture understands the stakes of the secondary market better than most: it literally operates one, with restoration and a fresh warranty. But that channel covers rare, out-of-production pieces sold through its own Boutiques. Everything else — the thousands of transactions between collectors, dealers and auction rooms — happens outside the perimeter where the manufacture's word is attached to the sale.

| Property | Certificate of Authenticity (today) | A portable proof |
| --- | --- | --- |
| Bound to | The named requester | The watch itself |
| Who can verify | The holder who requested it | Anyone, at the moment of transaction |
| Transfer at resale | No — new request via a Boutique | Yes — passes with the item |
| Contact with manufacture per sale | Required | Only at issuance |
...
Not in the way a transferable token would be. The certificate is nominative: it attests, for a named requester, that a specific watch was examined and certified by the manufacture. A new buyer who wants the manufacture's word must start a new request through a Boutique. Nothing in the public documentation describes a proof that passes from seller to buyer and that the buyer can verify independently at the moment of the transaction.
