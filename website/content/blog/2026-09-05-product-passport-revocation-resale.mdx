...
W3C makes the boundary explicit in [Bitstring Status List v1.0, section 1.1](https://www.w3.org/TR/vc-bitstring-status-list/#conceptual-framework): **“Status information is about the verifiable credential itself and might not apply to any underlying or backing credential”**. The Recommendation is dated 15 May 2025.
